...
$query = "SELECT *, DATE_FORMAT(created, '%m/%d/%y') AS created FROM it_data WHERE assignedto LIKE '".$technician."' ORDER BY id DESC LIMIT 500";
...
<div data-role="page" class="type-interior mybg">
	<div data-role="header" data-theme="a">
		<h1>View By Technician</h1>
		<a href="#" data-icon="home" data-iconpos="notext" data-direction="reverse" onclick="javascript:location.href='index.php'">Home</a>
	</div><!-- /header -->	
<br />
<div data-role="content">
<label for="basic"><b>Select technician to view.</b></label>
<br />
	<form name="tech" method="post" onSubmit="byTechnician.php">
			<select name="technician" onChange="sendForm()">
				<option selected value="">Select Technician</option>
				<option value="Richard Fletcher">Richard</option>
				<option value="Jay Fude">Jay</option>
				<option value="Randy Wallace">Randy</option>
				<option value="Matt Henshaw">Matt</option>
				<option value="Jodi Egbert">Jodi</option>
			</select>
	</form>
<?php
}
