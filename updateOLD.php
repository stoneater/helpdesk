...
if ($_POST['problem']){
	$problemSQL = mysql_real_escape_string(str_replace("\r\n", " ", ($_POST['problem'])));
...
?>
	...
	<p><?php print $error?></p>
		...
		setTimeout("top.location.href='viewAll.php'",3000);
		//-->
		</script>
	</div>
<?php
...
if (($action == 'update') AND ($delete != 'yes'))
{
		//Let's process the upload, if there is one
			...
			if ($email_notification)
			{
				...
				$mail->Body .= "http://linux.smithville.k12.mo.us/home/edit.php?id=" . $id . "\r\n";
